...
interface EnvVars {
    ...
    // ORDERS_MICROSEVICE_HOST: string;
    // ORDERS_MICROSEVICE_PORT: number;
    NATS_SERVERS: string[]
};
...
const envsSchema = joi.object({
    ...
    // ORDERS_MICROSEVICE_HOST: joi.string().required(),
    // ORDERS_MICROSEVICE_PORT: joi.number().required(),
...
export const envs = {
    ...
    // ordersMicroserviceHost: envVars.ORDERS_MICROSEVICE_HOST,
    // ordersMicroservicePort: envVars.ORDERS_MICROSEVICE_PORT,
